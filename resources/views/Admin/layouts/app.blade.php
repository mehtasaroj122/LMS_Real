...
<script>
    window.notificationAPI = {
        ...
        show: '{{ route("admin.notifications.show", "__ID__") }}',
        unreadCount: '{{ route("admin.notifications.unread-count") }}',
        markRead: '{{ route("admin.notifications.mark-read", "__ID__") }}',
        markAllRead: '{{ route("admin.notifications.mark-all-read") }}',
        delete: '{{ route("admin.notifications.destroy", "__ID__") }}',
        deleteAll: '{{ route("admin.notifications.delete-all-read") }}'
    };
</script>

<script src="{{ asset('admin/JS/services/notification-api.js') }}"></script>
<script src="{{ asset('shared/JS/components/notification-list-animator.js') }}"></script>
<script src="{{ asset('admin/JS/components/notification-list.js') }}"></script>
<script src="{{ asset('admin/JS/components/notification-detail-modal.js') }}"></script>
