...
class SearchBookController extends Controller
{
    ...
    public function requestBook(Request $request, NotificationService $notifications)
    {
        Gate::authorize('access-student');
        ...
        try {
            ...
            $notifications->notifyBookRequestCreated($bookRequest->load(['student.user', 'book']), includeAdmins: false);
